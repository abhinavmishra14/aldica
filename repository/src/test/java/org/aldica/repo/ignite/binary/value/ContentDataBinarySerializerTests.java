...
import org.aldica.repo.ignite.binary.value.ContentDataBinarySerializer;
    ...
    public void rawSerialFormEfficiency()
    {
        try (final GenericApplicationContext appContext = createApplicationContext())
        {
            ...
            try
            {
                ...
                // using an ID with variable length primitives is even more substantial - 48%
