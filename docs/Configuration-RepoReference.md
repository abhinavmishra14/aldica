...
| aldica.core.binary.optimisation.txnCacheKey.useVariableLengthIntegers | `${aldica.core.binary.optimisation.useVariableLengthIntegers}` | enablement flag for using variable length integer values in the raw serial form for `TransactionalCache$ValueHolder` instances |
